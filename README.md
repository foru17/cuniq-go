...
[在线体验 cuniq.zuoluo.tv](https://cuniq.zuoluo.tv/)
...
同一套代码还驱动了 [cmhk.zuoluo.tv](https://cmhk.zuoluo.tv/) —— 中国移动香港 (CMHK) 官网在售 +852 号码的筛选工具：

- 单一号源（无内地副号），普通号池与 C/D 级靓号分开浏览
- 通过 `NEXT_PUBLIC_CARRIER=cmhk` 环境变量切换载体，载体差异集中在 `src/lib/carrier.ts`
- CMHK 每次接口返回随机批次，站点会多批次抓取去重并保留近 6 小时内出现过的号码
